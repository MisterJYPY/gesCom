        ...
        <div class="row" >
            ...
            <div class="panel col-sm-11 col-md-11 "style="background-color:rgb(229,229,229);margin-left: 50px">
                <div class="panel-heading custom-header-panel">
                    <h1 class="panel-title roboto"><strong>Modifiez la reclamation</strong></h1>
                ...
                <div class="container">
                    ...
                    <div class="col-sm-8 contact-form" style="margin-top:70px;">
                        <form id="contact" method="post" class="form"  action="{{route('/updatereclamation',$reclamation->id)}}" >
                            <div class="row">

                                {{ csrf_field() }}
                                <div class="col-xs-6 col-md-6 form-group"><strong>Nom Client:</strong>
                                    <input class="form-control" id="nom" name="nom" value="{{$reclamation->nom}}" type="text" required  />
                                </div>
                                <div class="col-xs-6 col-md-6 form-group"><strong>Contact Client:</strong>
                                    <input class="form-control" id="contact" name="contact" value="{{$reclamation->contact}}" type="text" required />
                                </div>

                                <div class="col-xs-6 col-md-6 form-group"><strong>Adresse Client:</strong>
                                    <input class="form-control" id="adresse" name="adresse" value="{{$reclamation->adresse}}" type="text" required />
                                </div>
                                <div class="col-xs-6 col-md-6 form-group"><strong>Heure:</strong>
                                    <input class="form-control" id="timepicker_start" readonly="true" name="heure" value="{{$reclamation->heure}}" type="text" required />
                                </div>
                                <div class="col-xs-6 col-md-6 form-group"><strong>Date:</strong>(m/j/a)
                                    <input class="form-control" id="datepicker" readonly="true" name="date" value="{{$reclamation->date}}" type="text" required />
                                </div>

                                <div class="col-xs-6 col-md-6 form-group"><strong>Objet:</strong>
                                    <input class="form-control" id="objet" name="objet" value="{{$reclamation->objet}}" type="text" required />
                                </div>
