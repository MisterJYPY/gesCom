        ...
        <ul id="main-menu" class="nav navbar-nav navbar-right">
            <li class="dropdown hidden-xs">
                ...
                <ul class="dropdown-menu">
                    <li><a  href="#myModal22" role="button" class="btn btn-info " data-toggle="modal">Mon profil</a></li>
        ...
        <div class="modal-content">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <form class="form-horizontal" method="post" action="{{ route('modifPasswordUserAdmin') }}">
                        {{ csrf_field() }}
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header" style="background-color:rgb(204,204,255)" >
                ...
                <h2 id="myModalLabel"><strong style="color: darkblue">Ajoutez nouvel Utilisateur</strong></h2>
            </div>
                ...
                <div class="row">
                    ...
                    <form class="form-horizontal" method="post" action="{{ route('createUser') }}">
                        ...
                        <div class="form-group col-md-6 col-md-offset-2 " style="margin-left: 33%">
                            ...
                            <select id="FormMessageDestinatiare"class="form-control span12" name="admin">
...
<div class="sidebar-nav" style="background: url('images/kassi eric.png')" >
...
<div class="content">
    <div class="header">
        ...
        <div class="stats">
            ...
            <a href="#myModal12" role="button" class="btn btn-info " data-toggle="modal"><h7><i class="fa fa-plus"></i></h7>Nouvel Utilisateur</a>
    ...
    <div class="main-content ">
        ...
        <div class="btn-toolbar list-toolbar ">
            ...
            <a href="{{route('listClient')}}" role="button" class="btn btn-info " data-toggle="modal"></i><h7><i class="fa fa-users"></i></h7>Clients <span class="label label-warning">{{$listeDesClients}}</span></a>

            <a href="{{route('listRdv')}}" role="button" class="btn btn-danger " data-toggle="modal"><h7><i class="fa fa-bell"></i></h7>Rdv Programmés<span class="label label-warning">{{$tousLesRdv}}</span></a>


            <a href="{{route('listReclame')}}" role="button" class="btn btn-info " data-toggle="modal"><h7><i class="fa fa-envelope"></i></h7>reclamations<span class="label label-danger">{{$toutesLesReclam}}</span></a>
