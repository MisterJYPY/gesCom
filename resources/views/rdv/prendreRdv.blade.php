...
@section('content')
    ...
    <script type="text/javascript">
        ...
        (function() {
            var ga = document.createElement('script'); ga.type = '{{asset('text/javascript')}}}'; ga.async = true;
           ...
           minute: startTimePickerInst.minutes
            ...
            <div class="panel col-sm-11 col-md-11 " style="background-color:rgb(229,229,229);margin-left: 50px">
                <div class="panel-heading custom-header-panel">
                    <h2 class="panel-title roboto" style="color: darkblue"> <i class=" glyphicon glyphicon-time"></i>Pogrammer un <strong>RDV</strong> </h2>
                ...
                <div class="container">
                    ...
                    <div class="col-sm-8 contact-form" style="margin-top:70px;">
                        <form id="contact" method="post" class="form"  action="{{route('/programmerrvdclient',$rdv->id)}}" >
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-md-6 form-group"><strong>Pénom:</strong>
                                    <input class="form-control"  disabled="true" id="prenom" name="prenom" value="{{$rdv->prenom}}" type="text" required />
                                </div>

                                <div class="col-xs-6 col-md-6 form-group"><strong>Email:</strong>
                                    <input class="form-control" disabled="true" id="email" name="email" value="{{$rdv->email}}" type="email"  />
                                </div>
                                ...
                                <div class="col-xs-6 col-md-6 form-group"><strong>Date du RDV **:</strong>(m/j/a)
                                    <input class="form-control" id="datepicker" readonly="true" name="date"  type="tel" required />
                                </div>
                                <div class="col-xs-6 col-md-6 form-group"><strong>Heure Debut RDV **:</strong>
                                    <input class="form-control" readonly="true" id="timepicker_start" name="heured"  type="tel" required />
                                </div>

                                <div class="col-xs-6 col-md-6 form-group"><strong>Heure de Fin RDV **:</strong>
                                    <input class="form-control" id="timepicker_end"  readonly="true" name="heuref"  type="tel" required />
                                </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-12 form-group">
                                    <button class="btn btn-primary pull-right" type="submit">Programmer RDV</button></div></div>
                        </form>
                    </div>
                </div>
            </div>
